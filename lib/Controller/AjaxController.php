...
use OCA\NextRCP\Db\WorkInterval;
use OCP\AppFramework\Http\JSONResponse;
use OCA\NextRCP\Db\ClientMapper;
use OCA\NextRCP\Db\UserToClientMapper;
use OCA\NextRCP\Db\Client;
use OCA\NextRCP\Db\UserToClient;
use OCA\NextRCP\Db\ProjectMapper;
use OCA\NextRCP\Db\UserToProjectMapper;
use OCA\NextRCP\Db\Project;
use OCA\NextRCP\Db\UserToProject;
use OCA\NextRCP\Db\Tag;
use OCA\NextRCP\Db\TagMapper;
use OCA\NextRCP\Db\Goal;
use OCA\NextRCP\Db\GoalMapper;
use OCA\NextRCP\Db\UserToTagMapper;
use OCA\NextRCP\Db\UserToTag;
use OCA\NextRCP\Db\WorkIntervalToTag;
use OCA\NextRCP\Db\WorkIntervalToTagMapper;
use OCA\NextRCP\Db\ReportItemMapper;
use OCA\NextRCP\Db\TimelineMapper;
use OCA\NextRCP\Db\TimelineEntryMapper;
use OCA\NextRCP\Db\Timeline;
use OCA\NextRCP\Db\TimelineEntry;
